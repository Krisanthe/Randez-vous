...
class MyRobot (Robot):
  def run(self):
    ...
    while (self.step(TIME_STEP) != -1):
      ...
      if light_front > 0 or light_right > 0 or light_left > 0: 
        #print 'wykrylem',light_front,light_right,light_left,light_back
        
        
        if light_front == 1000:
          clearArray()
          array[wierszFront(k,angle)][kolumnaFront(l,angle)]  = -100
          wykrylem = True          
        elif light_right == 1000:
          wykrylem = True
          clearArray()
          array[wierszRight(k,angle)][kolumnaRight(l,angle)]  = -100
        elif light_left == 1000:
          clearArray()
          array[wierszLeft(k,angle)][kolumnaLeft(l,angle)]  = -100
          wykrylem = True
          ...
          if True: #wypelnianie tablicy rastrowej opisujacej mape
            if light_front == 1000:
              ...
              if (dis_front_left < 2600 or dis_front_right < 2600):
                if wierszFront(k,angle) >= 0 and wierszFront(k,angle) <= 19 and kolumnaFront(l,angle) >= 0 and kolumnaFront(l,angle) <= 19 and array[wierszFront(k,angle)][kolumnaFront(l,angle)] != -100:
            ...
            if light_right == 1000:
              ...
              if (dis_right_front > 2600 and dis_right_rear > 2600):
                if wierszRight(k,angle) >= 0 and wierszRight(k,angle) <= 19 and kolumnaRight(l,angle) >= 0 and kolumnaRight(l,angle) <= 19 and array[wierszRight(k,angle)][kolumnaRight(l,angle)] == 0:
                 ...
                 if wierszRight(k,angle) >= 0 and wierszRight(k,angle) <= 19 and kolumnaRight(l,angle) >= 0 and kolumnaRight(l,angle) <= 19 and array[wierszRight(k,angle)][kolumnaRight(l,angle)] != -100:
            ...
            if light_left == 1000:
              ...
              if (dis_left_front > 2600 and dis_left_rear > 2600):
                if wierszLeft(k,angle) >= 0 and wierszLeft(k,angle) <= 19  and kolumnaLeft(l,angle) >= 0 and kolumnaLeft(l,angle) <= 19 and array[wierszLeft(k,angle)][kolumnaLeft(l,angle)] == 0:
                  ...
                  if wierszLeft(k,angle) >= 0 and wierszLeft(k,angle) <= 19 and kolumnaLeft(l,angle) >= 0 and kolumnaLeft(l,angle) <= 19 and array[wierszLeft(k,angle)][kolumnaLeft(l,angle)] != -100:
            ...
            if False:
              ...
              if wierszFront(k,angle) >= 0 and wierszFront(k,angle) <= 19 and kolumnaFront(l,angle) <= 19 and kolumnaFront(l,angle) >= 0:
                dupa = array[wierszFront(k,angle)][kolumnaFront(l,angle)]
                if (dis_front_left > 2600 and dis_front_right > 2600) or light_front > 500:
              ...
              if wierszRight(k,angle) >= 0 and wierszRight(k,angle) <= 19 and kolumnaRight(l,angle) <= 19 and kolumnaRight(l,angle) >= 0:
                if (dis_right_front > 2600 and dis_right_rear > 2600) or light_right> 500:
              ...
              if wierszLeft(k,angle) >= 0 and wierszLeft(k,angle) <= 19 and kolumnaLeft(l,angle) <= 19 and kolumnaLeft(l,angle) >= 0:
                if (dis_left_front > 2600 and dis_left_rear > 2600) or light_left > 500:
                   wagaleft = wagi[wierszLeft(k,angle)][kolumnaLeft(l,angle)]
                else:
                  wagaleft = 800;             
              else:
                wagaleft = 800;
              #print 'SwiatloFront:',light_front
              #print 'FrontPoint:',dupa
              #print 'WagaFront:',wagafront
              #print 'WagaLeft:',wagaleft
             # print 'WagaRight:',wagaright
              
              if (dis_front_left < 2600 or dis_front_right < 2600) and light_front > 500:
                for i in range(4):
                  wheels[i].setVelocity(0)
                #print 'stop'
              elif (dis_right_front > 2600 and dis_right_rear > 2600)  and light_right >= 950:
                nowa_orientacja = get_new_orientation(get_bearing_in_degrees(), 'right')
                rotatingRight = True
              elif (dis_left_front > 2600 and dis_left_rear > 2600)  and light_left >= 950:
